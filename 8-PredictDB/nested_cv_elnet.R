...
get_gene_annotation <- function(gene_annot_file_name, chrom, gene_types=c('antisense', 'macro-lncRNA', 'lincRNA','processed-transcript','sense-intronic','sense-overlapping')){
